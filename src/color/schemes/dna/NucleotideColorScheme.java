...
public class NucleotideColorScheme implements ColorScheme{
	...
	public Hashtable<Character, Color> getColorTable() {
		...
		color_table.put(new Character('A'), new Color(100, 247, 63));
		color_table.put(new Character('G'), new Color(235, 65, 60));
		color_table.put(new Character('T'), new Color(60, 136, 238));
		color_table.put(new Character('C'), new Color(255, 179, 64));
		return color_table;
	}
}
